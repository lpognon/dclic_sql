    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teachers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="firstname">{{ trans('cruds.teacher.fields.firstname') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.teacher.fields.firstname_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="lastname">{{ trans('cruds.teacher.fields.lastname') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.teacher.fields.lastname_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="gender">{{ trans('cruds.teacher.fields.gender') }}</label>
